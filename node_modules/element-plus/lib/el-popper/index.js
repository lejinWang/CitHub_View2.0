...
function renderPopper(props, children) {
    const { effect, name, stopPopperMouseEvent, popperClass, popperStyle, popperRef, pure, popperId, visibility, onMouseEnter, onMouseLeave, onAfterEnter, onAfterLeave, } = props;
    const kls = [
        popperClass,
        'el-popper',
        'is-' + effect,
...
const emits = [UPDATE_VISIBLE_EVENT$1, 'after-enter', 'after-leave'];
var script = defineComponent({
    ...
    render() {
        var _a;
        const { $slots, appendToBody, class: kls, effect, hide, onPopperMouseEnter, onPopperMouseLeave, onAfterEnter, onAfterLeave, popperClass, popperId, popperStyle, pure, showArrow, transition, visibility, stopPopperMouseEvent, } = this;
