    ...
    (_ctx.showHeader)
      ? withDirectives((openBlock(), createBlock("div", _hoisted_2$1, [
          ...
          width: _ctx.layout.bodyWidth.value ? _ctx.layout.bodyWidth.value + 'px' : '',
            ...
            "onSet-drag-visible": _ctx.setDragVisible
          }, null, 8 /* PROPS */, ["border", "default-sort", "store", "style", "onSet-drag-visible"])
        ], 512 /* NEED_PATCH */)), [
        ...
        _ctx.fixedHeight,
          ...
          (_ctx.showHeader)
            ...
            width: _ctx.bodyWidth,
                  ...
                  fixed: "left",
                  "onSet-drag-visible": _ctx.setDragVisible
                }, null, 8 /* PROPS */, ["border", "store", "style", "onSet-drag-visible"])
              ], 512 /* NEED_PATCH */))
            : createCommentVNode("v-if", true),
          createVNode("div", {
