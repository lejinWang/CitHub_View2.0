  ...
  <el-col :xs="{ span: 24, offset: 0 }" :sm="{ span: 24, offset: 0 }" :md="{ span: 17, offset: 1 }" :lg="{ span: 17, offset: 1 }" :xl="{ span: 17, offset: 1 }">
    <div style="margin-bottom: 30px; width: 100%">
      ...
      <p class="text-secondary">
        Please be as detailed as possible when completing the following forms, so that others can easily understand and then work on your problem.      </p>
     
      <el-row>
        <el-form :model="taskInfor" :label-position="top" :rules="rules">
          <el-row>
            <h5 class="h5Title">Basic Information</h5>
            <el-form-item style="margin: 0px">
              <el-col :span="11" style="margin-left:16px">
                <el-form-item label="Name" prop="title">
                  <el-input v-model="taskInfor.title"></el-input>
                </el-form-item>
              </el-col>
                <el-col :span="11" :offset="1">
                <el-form-item label="Tags" prop="tags">
                  <el-input v-model="taskInfor.tags"></el-input>
                </el-form-item>
          ...
          <el-row>
            ...
            <el-col :span="23" style="margin-left:16px">
              <el-form-item label="Detailed Description" prop="description">
                ...
                <el-input type="textarea" v-model="taskInfor.description" rows="10"> </el-input>
              </el-form-item>
            </el-col>
          </el-row>
          ...
          <el-col :span="23" style="margin-left: 10px;">
            <el-form-item style="margin-top: 30px">
              <el-button type="primary" icon="el-icon-mouse" @click="submitForm('taskInfor')">Submit</el-button>
            </el-form-item>
          </el-col>
        </el-form>
      </el-row>
